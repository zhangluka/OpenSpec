...
import {
  ...
  getOpsxApplyRalphCommandTemplate,
...
export function getSkillTemplates(): SkillTemplateEntry[] {
  return [
    ...
    { template: getApplyRalphSkillTemplate(), dirName: "phspec-apply-ralph" },
...
export function getCommandTemplates(): CommandTemplateEntry[] {
  return [
    ...
    { template: getOpsxApplyRalphCommandTemplate(), id: "apply-ralph" },
